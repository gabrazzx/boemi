  ...
  return (
    ...
    >
      <div className="polaroid hover:scale-105 transition-all duration-500 hover-lift">
        ...
        <div className="relative overflow-hidden rounded-sm">
          ...
          {!imageLoaded && (
            <div className="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200 animate-pulse flex items-center justify-center">
              <Heart className="w-8 h-8 opacity-30" style={{ color: 'var(--burgundy)' }} />
            </div>
          )}
          
          {/* Enhanced Availability Badge */}
          <div className="absolute top-3 right-3">
            <span className={`px-3 py-1.5 text-xs font-vintage rounded-full backdrop-blur-sm border transition-all duration-300 ${
              product.available 
          ...
          <div className="absolute top-3 left-3 opacity-70 transition-all duration-300 group-hover:opacity-100 group-hover:scale-110">
            <Heart className="w-5 h-5 fill-current" style={{ color: 'var(--burgundy)' }} />
          </div>
          ...
          <div className={`absolute inset-0 bg-black/40 backdrop-blur-sm transition-all duration-300 flex items-center justify-center ${
            ...
            <div className="flex space-x-3">
              <button className="p-3 bg-white/90 rounded-full transition-all duration-300 hover:bg-white hover:scale-110">
        ...
        <div className="pt-4">
          <div className="handwritten text-center text-xl mb-3 transition-colors duration-300 group-hover:text-gradient" style={{ color: 'var(--burgundy)' }}>
            {product.name}
          </div>
          
          <div className="text-center mb-3">
            <span className="text-2xl font-serif font-medium" style={{ color: 'var(--charcoal)' }}>
          ...
          <div className="text-center mb-4">
            <p className="text-xs font-vintage mb-2 opacity-70" style={{ color: 'var(--charcoal)' }}>Tamanhos disponíveis:</p>
            <div className="flex justify-center flex-wrap gap-2">
              {product.sizes.map((size) => (
                <span
                  key={size}
                  className="px-3 py-1.5 text-xs rounded-full font-vintage transition-all duration-300 hover:scale-105 border"
                  style={{ 
          ...
          <div className="space-y-3">
            {product.available ? (
              <>
                {product.instagramLink && (
                  <a
                    ...
                    className="w-full flex items-center justify-center space-x-3 py-3 rounded-lg text-sm font-vintage transition-all duration-300 hover:scale-105 hover:shadow-lg group/btn"
              ...
              <button
                disabled
                className="w-full py-3 rounded-lg text-sm font-vintage cursor-not-allowed opacity-60 transition-all duration-300"
